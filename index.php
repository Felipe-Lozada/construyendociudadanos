...
<body>
    <div class="container-fluid">
        ...
        <div class="container-fluid">
        <footer class="row align-content-lg-between">
        <div class="col col-12 col-lg-4">© 2020 Contruyendo Ciudadanos.</div>
            <div class="col col-12 col-lg-4"><a href="#">Terminos y condiciones</a></div>
            <div class="col col-12 col-lg-4">Siguenos en nuestras redes sociales
                <div class="row align-content-lg-center">
                    <div class="col col-12 col-lg-6"><a href="#">Facebook: <img src="assets/ico/cc_facebook.png" alt="Redes Sociales de Construyendo ciudadanos: Facebook" width ="40px" heigth = "40px"></a></div>
                    <div class="col col-12 col-lg-6"><a href="#">Instagram: <img src="assets/ico/cc_instagram.png" alt="Redes Sociales de Construyendo ciudadanos: Instagram" width ="40px" heigth = "40px"></a></div>
                </div>
            </div>
        </footer>
        </div>
